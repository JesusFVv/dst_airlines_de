...
# Set some variables
readonly container_name="python_load_raw_reference_data"
readonly image_name_python="python:3.11-alpine3.20"
readonly image_name_app="python_load_reference_data_raw:latest"
...
cp /home/ubuntu/dst_airlines_de/bin/reference_data/*.sh ${tmp_build_context}/reference_data
cp /home/ubuntu/dst_airlines_de/bin/reference_data/*.py ${tmp_build_context}/reference_data
cp /home/ubuntu/dst_airlines_de/bin/reference_data/*.sql ${tmp_build_context}/reference_data
cp /home/ubuntu/dst_airlines_de/bin/reference_data/*.md ${tmp_build_context}/reference_data
